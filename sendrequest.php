    ...
    <div class="col-md-6">
      <ul class="list-group media-list media-list-stream">
        ...
        <li id="form" class="media list-group-item p-a">
          ...
          <form id="searchfriendform" action='searchfriend.php' method='post' role="form" class="m-x-auto text-center app-login-form">
              <input type="text" name="searchfriend" placeholder="Enter name">
