...
if ($row = $result->fetch_array()){
  ...
  $sqlcopst = "SELECT cpostid, username, ctitle, cpost_time, ctext, cpicture, mlocid from contents where cpostid = '$cid'";
  //echo $sql2;
...
$location = "Location: ".$rowlocation[2];
  //load the comments of this post
  $sqlcommentpost = "SELECT username, comtime, comtext, clike from comment where cpostid = '$cid'";
    ...
    <div class="col-md-6">
      <ul class="list-group media-list media-list-stream">
        ...
        <li class="media list-group-item p-a">
          ...
          <div class="media-body">
            <div class="media-heading">
              <h5 id="activitytitle">Post time:</h5>
            </div>
          ...
          <div class="media-body">
            <div class="media-heading">
              <h5 id="activitytitle">Content:</h5>
            </div>
          ...
          <div class="media-body">
            <div class="media-heading">
              <h5 id="activitytitle">Pictures:</h5>
            </div>
          ...
          <div class="media-body">
            <div class="media-heading">
              <h5 id="activitytitle">Comment time:</h5>
            </div>
          ...
          <div class="media-body">
            <div class="media-heading">
              <h5 id="activitytitle">Comment by:</h5>
            </div>
          ...
          <div class="media-body">
            <div class="media-heading">
              <h5 id="activitytitle">Like it?</h5>
            </div>
        ...
        <li id="form" class="media list-group-item p-a">
            <div class="media-body">
          <form id="commetform" action='commentpost.php' method='post' role="form" class="m-x-auto text-center app-login-form">
        <div id="newcomment" class="form-group">
            <textarea rows="6" cols="50" name ="body" class="form-control" placeholder="Your comments" ></textarea>
        </div>
