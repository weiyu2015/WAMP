...
//echo "asd";
//echo $username1;
$sql = "SELECT applyname as New_Friend
from add_friend
where addedname='$username1' and astatus = 0";
$result = $mysqli->query($sql);
if (!empty($result))
{
	 while($row = mysqli_fetch_array($result))
	 {
		$request .= "$row[New_Friend]";
		$request .= '<a style="text-decoration:none" href="friendaccept.php?applyname='.$row['New_Friend'].'">			Accept</a>';
        $request .= '<a style="text-decoration:none" href="frienddecline.php?applyname='.$row['New_Friend'].'">     Decline</a><br>';
	}
}
else
{
        ...
        <li class="media list-group-item p-a">
          <div class="media-body">
            <div class="media-heading">
              <h5 id="activitytitle">Requests:</h5>
            </div>
